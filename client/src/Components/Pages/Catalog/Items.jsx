...
const Items = () => {
  ...
  return (
    <>
      {productsList
        && productsList.map(({ name, id, price, img, producer }) => (
          <Grid item xs="12" sm="6" md="4">
            <div className="list" id={id} key={id}>
              <div className="list__item">
                <img className="list__item--img" src={require(`${img}`)} alt="laptop" />
                <span className="list__item--rating">
                  <span className="list__item--rating--line" />
                </span>
                <span>
                ...
                <button type="button" className="list__item--information">
                  Information
                </button>
              </div>
            </div>
