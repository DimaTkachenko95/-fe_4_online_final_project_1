  ...
  <main>
    <Container maxWidth="lg">
      <h5 className="count-found-product">
        Products
        <span className="count-found-product__span">found</span>
      </h5>
      <div className="main-filter-block">
        <div className="main-filter-block__popular">
          <button type="button" className="main-filter-block__popular--btn">
            By price
          </button>
          <button type="button" className="main-filter-block__popular--btn">
            By popular
        ...
        <div className="main-filter-block__direction">
          <button type="button" className="main-filter-block__direction--btn">
            <Bottom />
          </button>
          <button type="button" className="main-filter-block__direction--btn">
            <Top />
